...
namespace RpgApi.Controllers
{
    ...
    public class PersonagensExercicioController : ControllerBase
    {
        private static List<Personagem> personagens = new List<Personagem>()
        {
            ...
            new Personagem() { Id = 3, Nome = "Galadriel", PontosVida=70, Forca=18, Defesa=21, Inteligencia=35, Classe=ClasseEnum.Clerigo },
            ...
            new Personagem() { Id = 7, Nome = "Radagast", PontosVida=120, Forca=25, Defesa=11, Inteligencia=35, Classe=ClasseEnum.Mago }
        };
